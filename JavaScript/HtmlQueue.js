var HtmlQueue = /** @class */ (function () {
    ...
    HtmlQueue.renderQueueSubscribers = function (subscribers) {
        ...
        for (var _i = 0, subscribers_1 = subscribers; _i < subscribers_1.length; _i++) {
            ...
            html += "<table class=\"table-dark\" style=\"width:200px; box-shadow: 0 0 3px black;\"\">\n<tr>\n<td>".concat(HtmlMain.drawLed(itm.subscriber.active > 0, 'blue'), "<div style=\"margin-top: 10px;font-size: 12px;\"><span class=\"badge badge-secondary\">").concat(itm.session.id, "</span></div></td>\n<td padding: 0;\">\n<div style=\"margin-top: 10px;font-size: 12px;\"><span class=\"badge ").concat(subscriber_badge, "\">").concat(itm.subscriber.id, "</span></div>\n<div style=\"font-size:10px; color:white\">").concat(itm.session.name, "</div><div style=\"font-size:10px; color:white\">").concat(itm.session.version, "</div><div style=\"font-size:10px; color:white\">").concat(itm.session.ip, "</div>\n").concat(HtmlGraph.renderGraph(itm.subscriber.history, function (c) { return Utils.format_duration(c); }, function (c) { return Math.abs(c); }, function (c) { return c < 0; }), "</td></tr></table>");
        }
        return html;
    };
    return HtmlQueue;
